...
const NewWithdrawal = () => {
  ...
  const url = `https://new-swifteatrn-back-end.vercel.app/api/requestwithdrawcode/${id}`
  const urlll = `https://new-swifteatrn-back-end.vercel.app/api/withdraw/${id}`
  const urlprofit = `https://new-swifteatrn-back-end.vercel.app/api/transferprofittoaccount/${id}`
  const urlemail = `https://new-swifteatrn-back-end.vercel.app/api/withdrawalemailsend/${id}`
